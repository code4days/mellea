...
#### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `act` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.4.1/mellea/stdlib/session.py#L417" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `act` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.4.1/mellea/stdlib/session.py#L429" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `instruct` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.4.1/mellea/stdlib/session.py#L494" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `instruct` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.4.1/mellea/stdlib/session.py#L512" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `aact` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.4.1/mellea/stdlib/session.py#L731" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `aact` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.4.1/mellea/stdlib/session.py#L745" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `aact` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.4.1/mellea/stdlib/session.py#L759" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `aact` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.4.1/mellea/stdlib/session.py#L772" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `ainstruct` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.4.1/mellea/stdlib/session.py#L842" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `ainstruct` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.4.1/mellea/stdlib/session.py#L862" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `ainstruct` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.4.1/mellea/stdlib/session.py#L882" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `ainstruct` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.4.1/mellea/stdlib/session.py#L901" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `aquery` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.4.1/mellea/stdlib/session.py#L1057" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `aquery` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.4.1/mellea/stdlib/session.py#L1068" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
